...
# PCoA and NMDS plots colored by variable (host animal and sample type)
...
# calves with rumen and feces sampled on the same day and overlapping animals from global fecal mycobiome survey were used
